    ...
    return (
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                <section className="feedback-section bg-[url('/images/bx g-small.svg') bg-cover h-[100vh] sticky top-0 items-center justify-center">
                    {imageUrl && resumeUrl && (
                ...
                <section className="feedback-section">
                    ...
                    {feedback ? (
                        ...
                        <img src="/images/resume-scan-2.gif" alt="resume gif" className="w-full"/>
                    )}
                </section>
            </div>
        </main>
